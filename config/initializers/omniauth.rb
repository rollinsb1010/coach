# Only use if Devise.rb does not exist -- otherwise all login config is funnelled through Devise 
...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '106984622805054', '0a7037f44ed1f43fe8b2b82e0cd39c25',
    :client_options => {:ssl => {:ca_path => "/Users/rollinsb/.rvm/usr/ssl" }}
  provider :identity, on_failed_registration: lambda {
    |env| IdentitiesController.action(:new).call(env)
  }                                               
end
